...
Closer to the start of the conference, we will invite you to the posit::conf Discord server, share the repository containing the slides and further instructions to be ready.
